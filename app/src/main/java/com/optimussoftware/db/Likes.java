...
public class Likes implements java.io.Serializable {
    ...
    private User myLikes;

    @Generated
    private transient String myLikes__resolvedKey;
    ...
    @Generated
    public Likes(String _id, String _etag, java.util.Date created, java.util.Date updated, Boolean active, Boolean deleted, String advertising_id, String user_id) {
        this._id = _id;
        this._etag = _etag;
    ...
    @Generated
    public User getMyLikes() {
        String __key = this.user_id;
        if (myLikes__resolvedKey == null || myLikes__resolvedKey != __key) {
            __throwIfDetached();
            UserDao targetDao = daoSession.getUserDao();
            User myLikesNew = targetDao.load(__key);
            synchronized (this) {
                myLikes = myLikesNew;
            	myLikes__resolvedKey = __key;
            }
        }
        return myLikes;
    }
