...
/** 
 * DAO for table "DISLIKES".
*/
public class DislikesDao extends AbstractDao<Dislikes, String> {

    public static final String TABLENAME = "DISLIKES";

    /**
     * Properties of entity Dislikes.<br/>
    ...
    private Query<Dislikes> user_TheUserDislikeQuery;

    public DislikesDao(DaoConfig config) {
        super(config);
    }
    
    public DislikesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DISLIKES\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DISLIKES\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Dislikes entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Dislikes entity) {
        stmt.clearBindings();
        stmt.bindString(1, entity.get_id());
    ...
    @Override
    protected final void attachEntity(Dislikes entity) {
    ...
    @Override
    public Dislikes readEntity(Cursor cursor, int offset) {
        Dislikes entity = new Dislikes( //
    ...
    @Override
    public void readEntity(Cursor cursor, Dislikes entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(Dislikes entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(Dislikes entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Dislikes entity) {
    ...
    /** Internal query to resolve the "TheUserDislike" to-many relationship of User. */
    public List<Dislikes> _queryUser_TheUserDislike(String user_id) {
        synchronized (this) {
            if (user_TheUserDislikeQuery == null) {
                QueryBuilder<Dislikes> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.User_id.eq(null));
                user_TheUserDislikeQuery = queryBuilder.build();
            }
        }
        Query<Dislikes> query = user_TheUserDislikeQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM DISLIKES T");
    ...
    protected Dislikes loadCurrentDeep(Cursor cursor, boolean lock) {
        Dislikes entity = loadCurrent(cursor, 0, lock);
        int offset = getAllColumns().length;

        User myDislikes = loadCurrentOther(daoSession.getUserDao(), cursor, offset);
         if(myDislikes != null) {
            entity.setMyDislikes(myDislikes);
        }

        return entity;    
    }

    public Dislikes loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Dislikes> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Dislikes> list = new ArrayList<Dislikes>(count);
    ...
    protected List<Dislikes> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Dislikes> queryDeep(String where, String... selectionArg) {
