 ...
 */
public class UserRegisterNoSocialPermissionsListener implements MultiplePermissionsListener {

    private final UserRegisterActivity activity;

    public UserRegisterNoSocialPermissionsListener(UserRegisterActivity activity) {
