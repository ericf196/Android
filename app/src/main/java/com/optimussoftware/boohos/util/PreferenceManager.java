...
public class PreferenceManager {
    ...
    public PreferenceManager(Context context) {
        TAG = Commons.getTag(context, PreferenceManager.class);
    ...
    public float getFloat(String key, float default_value) {
        try {
            return Float.parseFloat(mPref.getString(key, default_value + ""));
        } catch (Exception e) {
            return mPref.getFloat(key, default_value);
        }
    }
    ...
    public void setDate(String key, Date value) {
        ...
        //editor.commit();//androidLint "Problem resolution Replace commit() with apply()"
        editor.apply();
    }
