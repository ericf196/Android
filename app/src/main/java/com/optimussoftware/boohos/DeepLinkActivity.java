...
public class DeepLinkActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_deep_link);

        // Validate that the developer has set the app code.
        validateAppCode();

        // Create a deep link and display it in the UI
        final Uri deepLink = buildDeepLink(Uri.parse(DEEP_LINK_URL), 1, false);
    ...
    private void shareDeepLink(String deepLink) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "Link construido " + deepLink);
